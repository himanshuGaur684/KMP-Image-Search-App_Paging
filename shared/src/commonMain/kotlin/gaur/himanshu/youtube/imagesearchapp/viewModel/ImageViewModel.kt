...
class ImageViewModel(
    ...
    private val imagesRepository: ImageRepository by inject()
    ...
    val images = _query
        ...
        .debounce(500)
        .flatMapLatest { q -> imagesRepository.getImages(q).flow.cachedIn(viewModelScope.coroutineScope) }
    ...
    init {
        ...
        viewModelScope.launch {
//            hitsPresenter.loadStateFlow.filterNotNull()
...
//            }
    ...
    private suspend fun updateSnapshotList(event: PagingDataEvent<Hit>) {
         if(hitsSnapshotList.value != hitsPresenter.snapshot()){
